...
Abre la app de esta carpeta o descomprime **Vocalia-1.0.1-macOS-AppleSilicon-Tour.zip**. Puedes arrastrarla a Aplicaciones. Requiere Apple Silicon y macOS 26 o posterior. Está compilada localmente y firmada para uso local; no está notarizada para distribución pública. No necesita micrófono para transcribir archivos.

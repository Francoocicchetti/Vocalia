...
[Español](INSTALL-MAC.es.md) · [Downloads](https://github.com/Francoocicchetti/Vocalia/releases/tag/v0.0.5)
...
1. Download **Vocalia-0.0.5-macOS-AppleSilicon.zip** from the official Vocalia GitHub Release.

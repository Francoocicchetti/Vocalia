...
[Español](INSTALL-MAC.es.md) · [Downloads](https://github.com/Francoocicchetti/Vocalia/releases/tag/v0.0.6)
...
1. Download **Vocalia-0.0.6-macOS-AppleSilicon.zip** from the official Vocalia GitHub Release.

# Install Vocalia 1.0 on Mac

[Español](INSTALL-MAC.es.md) · [Downloads](https://github.com/Francoocicchetti/Vocalia/releases/tag/v1.0.0)
...
1. Download **Vocalia-1.0-macOS-AppleSilicon.zip** from the official Vocalia GitHub Release.

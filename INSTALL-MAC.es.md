...
[English](INSTALL-MAC.md) · [Descargas](https://github.com/Francoocicchetti/Vocalia/releases/tag/v1.0.1)
...
1. Descarga **Vocalia-1.0.1-macOS-AppleSilicon-GuideFix.zip** desde la Release oficial de Vocalia en GitHub.

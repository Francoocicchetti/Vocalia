...
El código para Mac está en los archivos Swift y `ui-translations.json`; se compila con `zsh build.sh` y las herramientas de Apple con SDK macOS 26. El de Windows está en la carpeta `Vocalia-Windows/`; requiere Python 3.12 x64 y `build.ps1`, además de Inno Setup 6 para el instalador. La versión incluye un paquete con todo el código.

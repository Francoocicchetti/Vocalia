...
### [↓ Instalador para Windows 11 — Intel / AMD](https://github.com/Francoocicchetti/Vocalia/releases/download/v1.0.3/Vocalia-1.0.3-Windows-x64-Setup.exe)

### [↓ MacBook / Mac — Apple Silicon](https://github.com/Francoocicchetti/Vocalia/releases/download/v1.0.3/Vocalia-1.0.3-macOS-AppleSilicon.zip)

[Todos los archivos y verificaciones de la versión 1.0.3](https://github.com/Francoocicchetti/Vocalia/releases/tag/v1.0.3)

| Equipo | Requisitos | Archivo |
| --- | --- | --- |
| Windows | Windows 11, Intel/AMD de 64 bits | `Vocalia-1.0.3-Windows-x64-Setup.exe` |
| MacBook / Mac | Apple Silicon M1 o posterior, macOS 26+ | `Vocalia-1.0.3-macOS-AppleSilicon.zip` |
